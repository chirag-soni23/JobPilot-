        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 bg-white dark:bg-gray-900 rounded-lg p-6 shadow-lg">
            <div className="flex items-start gap-4 mb-6">
              ...
              <button className="ml-auto p-2 cursor-pointer rounded-md">
                <img src={assets.save} className="w-10 h-10 text-gray-500 dark:text-gray-300" alt="" />
              </button>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-300">
                <OverviewItem
                  ...
                  label="JOB POSTED"
                  value={new Date(postedDate).toLocaleDateString()}
                />
                <OverviewItem
                  icon={assets.timer}
                  label="JOB EXPIRE"
                  value={new Date(expireDate).toLocaleDateString()}
                />
                <OverviewItem
                  icon={assets.stack}
                  label="JOB LEVEL"
