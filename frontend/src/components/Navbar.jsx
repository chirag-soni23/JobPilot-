      ...
      <nav className="bg-white shadow-md px-6 md:px-20 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to="/findjob" className={navLinkClass("/findjob")}>Find Jobs</Link>
        ...
        {isOpen && (
          <div className="mt-4 flex flex-col gap-4 md:hidden">
            <Link to="/" className={`${navLinkClass("/")} w-fit`}>Home</Link>
            <Link to="/findjob" className={`${navLinkClass("/findjob")} w-fit`}>Find Jobs</Link>
            <Link to="/contact" className={`${navLinkClass("/contact")} w-fit`}>Contact</Link>
